...
class PatternTests extends GroovyTestCase {
  static IP = new Pattern('ip4') | new Pattern('ip6')
  static TCP = IP & new Pattern('tcp')
  static UDP = IP & new Pattern('udp')
  static UTP = UDP & new Pattern('utp')
  static Unreliable = UDP
  static Reliable = TCP | UTP
  static IPFS = Reliable & new Pattern('ipfs')
